...
//            insertCommand.Parameters.AddWithValue("@PATIENTNO", txtPatientNo.Text);
...
//            insertCommand.Parameters.AddWithValue("@GROUPCODE", txtgroupcode.Text);
//            insertCommand.Parameters.AddWithValue("@PIC1", txtImage1.Text.Trim());
//            insertCommand.Parameters.AddWithValue("@NOTE1", imagenotes[0, 0]);
//            insertCommand.Parameters.AddWithValue("@PIC2", txtImage2.Text.Trim());
//            insertCommand.Parameters.AddWithValue("@NOTE2", imagenotes[1, 0]);
//            insertCommand.Parameters.AddWithValue("@PIC3", txtImage3.Text.Trim());
//            insertCommand.Parameters.AddWithValue("@NOTE3", imagenotes[2, 0]);
//            insertCommand.Parameters.AddWithValue("@PIC4", txtImage4.Text.Trim());
//            insertCommand.Parameters.AddWithValue("@NOTE4", imagenotes[3, 0]);
//            insertCommand.Parameters.AddWithValue("@PIC5", txtImage5.Text.Trim());
//            insertCommand.Parameters.AddWithValue("@NOTE5", imagenotes[4, 0]);
//            insertCommand.Parameters.AddWithValue("@PIC6", txtImage6.Text.Trim());
//            insertCommand.Parameters.AddWithValue("@NOTE6", imagenotes[5, 0]);
//            insertCommand.Parameters.AddWithValue("@PIC7", txtImage7.Text.Trim());
//            insertCommand.Parameters.AddWithValue("@NOTE7", imagenotes[6, 0]);
//            insertCommand.Parameters.AddWithValue("@PIC8", txtImage8.Text.Trim());
//            insertCommand.Parameters.AddWithValue("@NOTE8", imagenotes[7, 0]);
//            insertCommand.Parameters.AddWithValue("@PIC9", txtImage9.Text.Trim());
//            insertCommand.Parameters.AddWithValue("@NOTE9", imagenotes[8, 0]);
//            insertCommand.Parameters.AddWithValue("@PIC10", txtImage10.Text.Trim());
...
//            insertCommand.Parameters.AddWithValue("@pdffile1", txtPDF1.Text.Trim());
//            insertCommand.Parameters.AddWithValue("@pdffile2", txtPDF2.Text.Trim());
//            insertCommand.Parameters.AddWithValue("@pdffile3", txtPDF3.Text.Trim());
//            insertCommand.Parameters.AddWithValue("@pdffile4", txtPDF4.Text.Trim());
//            insertCommand.Parameters.AddWithValue("@pdffile5", txtPDF5.Text.Trim());
//            insertCommand.Parameters.AddWithValue("@pdffile6", txtPDF6.Text.Trim());
//            insertCommand.Parameters.AddWithValue("@pdffile7", txtPDF7.Text.Trim());
//            insertCommand.Parameters.AddWithValue("@pdffile8", txtPDF8.Text.Trim());
//            insertCommand.Parameters.AddWithValue("@pdffile9", txtPDF9.Text.Trim());
...
//            {
//                MessageBox.Show("Image Acquisition " + ex, "", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
//                return;
//            }
//            finally
//            {
//                connection.Close();
//                DialogResult result1 = MessageBox.Show("Done...");
//            }
//        }
